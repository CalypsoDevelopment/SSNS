 ...
 * making it possible to make a single smart contract call to resolve an SSNS name.
 */
contract UniversalResolver is ERC165, Ownable {
    ...
    SSNS public immutable registry;

    constructor(address _registry, string[] memory _urls) {
        registry = SSNS(_registry);
    ...
    /*
     * @dev Performs SSNS name resolution for the supplied name and resolution data.
     * @param name The name to resolve, in normalised and DNS-encoded form.
     * @param data The resolution data, as specified in SSNSIP-10.
    ...
    /*
     * @dev Performs SSNS name reverse resolution for the supplied reverse name.
