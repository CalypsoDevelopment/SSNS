...
contract OffchainDNSResolver is IExtendedResolver {
    ...
    constructor(SSNS _ssns, DNSSEC _oracle, string memory _gatewayURL) {
        ssns = _ssns;
        oracle = _oracle;
    ...
    function resolveCallback(
        ...
        for (
            ...
            // Look for a valid SSNS-DNS TXT record
    ...
    function parseRR(
        ...
        if (txt.length < 5 || !txt.equals(0, "SSNS1 ", 0, 5)) {
            return (address(0), "");
        }
    ...
    function resolveName(
        ...
        address resolver = ssns.resolver(node);
